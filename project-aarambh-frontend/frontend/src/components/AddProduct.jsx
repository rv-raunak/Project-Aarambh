...
const AddProduct = () => {
  ...
  const submitHandler = (event) => {
    ...
    // THE FIX: Explicitly providing id: 0 and bulletproofing the number conversions
    const formattedProduct = {
      ...product,
      id: 0, // Solves the "Cannot map 'null' into type 'int'" error for the missing ID!
      price: Number(product.price) || 0, // Number() prevents NaN (which becomes null in JSON)
